// Estructura segura para interceptar la llamada a paginate sin perder referencias de Jest
...
describe('PostsService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        PostsService,
        // Usamos los tokens string directos para evitar que falle la inyección
        { provide: 'PostRepository',     useValue: mockPostsRepository },
        { provide: 'CategoryRepository', useValue: mockCategoriesRepository },
      ],
    }).compile();
