...
const cantidadpraductos = prompt("Cantidad Productos comprados: ");

const a = parseFloat(cantidadpraductos) || 0;
...
const contraseña = prompt('Ingresa contraseña: ');
const constraseñacorrecta = "hola";

if (contraseña === constraseñacorrecta){
...
const horaA = prompt("Ingrese hora (formato 0-23)"); // hora en formato 24h
